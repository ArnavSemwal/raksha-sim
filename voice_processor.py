...
def extract_symptoms(audio_file_path: str) -> list:
    ...
    try:
        ...
        symptom_ner = pipeline("token-classification", model="d4data/biomedical-ner-all")
        
        transcript = transcriber(audio_file_path)["text"].lower()
        ...
        fallback_keywords = [
            "chest pain", "shortness of breath", "fever", "dizzy", "dizziness", "fainting", "faint", 
